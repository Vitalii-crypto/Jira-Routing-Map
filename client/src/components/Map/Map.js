    ...
    return (
        <>
            ...
            <div className='input-container'>
                <label>
                    <Autocomplete onPlaceChanged={(e) => {
                        onOriginInputChange({target: originRef.current})
                    }}>
                ...
                <label>
                    <Autocomplete onPlaceChanged={(e) => {
                        onDestinationInputChange({target: destinationRef.current})
                    }}>
                        <input ref={destinationRef} placeholder="Point B" className='destination'
